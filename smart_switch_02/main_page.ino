void handleRoot() {
  ...
  html += "<div id=\"pbut\" >";
  html += load_on_1 ? "<center><a href=\"#\" class=\"btn_on\" onclick=\"on_off()\">Выключить канал 1</a></center>" : "<center><a href=\"#\" class=\"btn_off\" onclick=\"on_off()\">Включить канал 1</a></center>";
  html += "</div><br>";
  html += "<div id=\"pbut2\" >";
  html += load_on_2 ? "<center><a href=\"#\" class=\"btn_on\" onclick=\"on_off2()\">Выключить канал 2</a></center>" : "<center><a href=\"#\" class=\"btn_off\" onclick=\"on_off2()\">Включить канал 2</a></center>";
  html += "</div><br>";
  html += "<br></div></body>";
