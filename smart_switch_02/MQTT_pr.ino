...
void send_mqtt(String tops, String data, String subscr) {
    if(!annonce_mqtt_discovery) {
        ...
        deviceDoc["name"] = "Двухканальное реле";
        ...
        //  Переключатель канал 1
        {
            ...
            doc["unique_id"] = ch_id + "_s1_off";
            publishConfig("switch", ch_id + "_s1_off", doc);
        }
                //  Переключатель канал 2
        {
            DynamicJsonDocument doc(512);
            doc["name"] = "Канал 2";
            doc["command_topic"] = control;
            ...
            doc["state_on"] = "On";
            doc["state_off"] = "Off";
            doc["value_template"] = "{{ value_json.c2 }}";
            doc["unique_id"] = ch_id + "_s2_off";
            publishConfig("switch", ch_id + "_s2_off", doc);
        }
