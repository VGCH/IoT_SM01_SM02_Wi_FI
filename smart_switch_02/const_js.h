...
// js
         ...
         var worktime = new XMLHttpRequest();
          ...
          if (worktime.readyState === 4 && worktime.status === 200) {
                ...
                if(last_st !== obj.chanel1){
                   last_st = obj.chanel1;
                   if(obj.chanel1 === "On"){
                      document.getElementById("pbut").innerHTML = "<center><a href=\"#\" class=\"btn_on\" onclick=\"on_off()\">Выключить канал 1</a></center>";
                   }else{
                      document.getElementById("pbut").innerHTML = "<center><a href=\"#\" class=\"btn_off\" onclick=\"on_off()\">Включить канал 1</a></center>";
                   }
                 }
                  if(last_st_2 !== obj.chanel2){
                   last_st_2 = obj.chanel2;
                   if(obj.chanel2 === "On"){
                      document.getElementById("pbut2").innerHTML = "<center><a href=\"#\" class=\"btn_on\" onclick=\"on_off2()\">Выключить канал 2</a></center>";
                    }else{
                      document.getElementById("pbut2").innerHTML = "<center><a href=\"#\" class=\"btn_off\" onclick=\"on_off2()\">Включить канал 2</a></center>";
                   }
                 }
      ...
      function on_off(){
         ...
         var power = new XMLHttpRequest();
             power.open('POST','?page=indata',true);
             power.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
      ...
      function on_off2(){
         ...
         var power = new XMLHttpRequest();
          ...
          if (power.readyState === 4 && power.status === 200) {
                var data = power.responseText;
                var myArray = data.split("0");
                document.getElementById("pbut2").innerHTML    = myArray[0];
                 }
              }
             document.getElementById("pbut2").innerHTML  = "<center>Секундочку...</center>";
             power.send('switch_n=' + data);
           }     
